...
$action = $data['action'] ?? null; // e.g. 'auto_tone'
...
if ($ADOBE_CLIENT_ID === "YOUR_CLIENT_ID") {
    ...
    echo json_encode([
        ...
        'url' => $image, 
        'mock' => true, 
        'message' => "Mock Lightroom $action executed. Add Adobe API Keys to connect to real servers."
    ]);
    exit;
}
...
// 3. Call Lightroom API endpoint (e.g. Auto-tone)
// 4. Download result
